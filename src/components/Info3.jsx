...
const ImageLayout = ({ videosrc, image2, title, subtitle }) => {
  ...
  return (
    <div className="w-full h-screen flex flex-col bg-white  overflow-x-hidden ">
      {/* Image Container */}
      <div className="w-full h-[65vh] flex flex-col md:flex-row relative">
      ...
      {/* Text Container */}
      <div className="w-full h-[35vh] flex flex-col text-center items-center justify-center bg-white p-4 mt-[-10%] md:mt-0">
